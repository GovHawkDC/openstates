...
from .bills import AustinBillScraper

# from .events import A2EventScraper

class Austin(State):
    division_id = "ocd-division/country:us/state:tx/place:Austin"
    classification = "legislature"
    name = "Austin"
    legislature_name = "City Council"
    url = "https://cityofAustin.legistar.com/"
    scrapers = {
        "bills": AustinBillScraper,
    ...
    metadata = modelState(
        ...
        fips="48",
        unicameral=True,
        legislature_name="Austin City Council",
        ...
        division_id="ocd-division/country:us/state:az/place:Austin",
        jurisdiction_id="ocd-division/country:us/state:az/place:Austin/government",
        url="https://cityofAustin.legistar.com//Calendar.aspx",
        legislature=Chamber(
            chamber_type="upper",
            name="City Council",
