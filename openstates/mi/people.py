...
class MIPersonScraper(Scraper):
    ...
    def scrape_lower(self, chamber):
        ...
        for row in doc.xpath('//table[@id="grvRepInfo"]/*'):
            ...
            office = re.sub(
                " HOB", " Anderson House Office Building\n124 North Capitol Avenue\nLansing, MI 48933", office,
            )
            ...
            person = Person(name=name, district=district, party=abbr[party], primary_org="lower", image=photo_url,)
    ...
    def scrape_upper(self, chamber):
        ...
        for row in doc.xpath('//table[not(@class="calendar")]//tr')[1:]:
            ...
            if party.text_content().strip() == "" or "Lieutenant Governor" in member.text_content():
                continue
            ...
            office_loc = loc.text
            office_loc = re.sub(
                " Farnum Bldg", " Farnum Office Building\n125 West Allegan Street\nLansing, MI 48933", office_loc,
            )
            office_loc = re.sub(" Capitol Bldg", " State Capitol Building\nLansing, MI 48909", office_loc,)
            ...
            email = None
            contact_url = [a for a in row.xpath(".//a") if a.text in ("Contact Me", "Conact Me")][0].get("href")
            try:
                ...
                if header_email:
                    ...
                    text_email = [a for a in links if "mailto:" in (a.get("href") or "")]
                    if text_email:
    ...
    def get_photo_url(self, url):
        ...
        doc = lxml.html.fromstring(data)
        doc.make_links_absolute(url)
        return doc.xpath('//div[contains(@class, "headshotTop")]//img/@src') + doc.xpath(  # housedems.com
