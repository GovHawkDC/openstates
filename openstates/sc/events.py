...
class SCEventScraper(Scraper):
    ...
    def scrape(self, chamber=None, session=None):
        ...
        if chamber is None:
            ...
            events_url = "http://www.scstatehouse.gov/meetings.php?chamber=%s" % (chambers[chamber]["name"].upper()[0])
        ...
        for date in dates:
            ...
            if date_string.count(",") == 2:
                ...
                raise AssertionError("This is not a valid date: '{}'").format(date_string)
            ...
            for meeting in date.xpath("li"):
                ...
                date_time = datetime.datetime.strptime(
                    event_year + " " + date_string + " " + time_string, "%Y %A, %B %d %I:%M %p",
                )
                ...
                if agenda_url:
                    ...
                    event.add_document(note="Agenda", url=agenda_url, media_type="application/pdf")
